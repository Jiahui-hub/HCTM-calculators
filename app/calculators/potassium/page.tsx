  ...
  return (
    <div className="min-h-screen bg-gray-100 flex justify-center p-6 font-sans">
      <div className="w-full max-w-4xl bg-white rounded-[2rem] shadow-2xl p-10 space-y-8 transition-all duration-300">
        ...
        {/* Warning Message */}
        {potassiumWarning && (
          <div className={`p-4 rounded-[1rem] shadow ${warningColor} transition`}>
            ⚠ {potassiumWarning}
          </div>
        )}
        ...
        {/* Results Card */}
        {deficit > 0 && (
          <div className="bg-green-50 p-6 rounded-[1.5rem] shadow-xl mt-8 hover:shadow-2xl transition duration-300">
